...
print (X_train.head()) #used for training
print(y_train.sample(5)) ##used for testing

#now use transformer from scikit learn
...
# Feature selection
trf4 = SelectKBest(score_func=chi2,k=8) #in this we can also take k=5 i.e. top 5 columns for prediction
